...
** Exgexp.prototype.exec(str[,index])
...
** Exgexp.prototype.test(str[,index])
...
$$
\forall e \in C, \implies e \in A,\text{ and } e \notin B
$$.
...
$$
\forall e \in C, \implies e \in A \text{ or } e \in B
$$
...
$$
\forall e\in C, \implies e \in A \text{ and } e \in B
$$
...
In Math \forall e \in C, e \in A and e\in B but 
e \notin A \cup B.
